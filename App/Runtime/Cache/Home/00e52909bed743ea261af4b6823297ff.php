	...
	<div class="col-sm-3">
	    <div class="ibox float-e-margins">
	        ...
	        <div class="ibox-content">
	            <h1 class="no-margins"><?php echo (money_format($all_borrow_money)); ?></h1>
      ...
      <div class="col-sm-3">
          <div class="ibox float-e-margins">
              ...
              <div class="ibox-content">
                  <h1 class="no-margins"><?php echo (money_format($now_borrow_interest)); ?></h1>
                  <div class="stat-percent font-bold text-success"></div>
                  <small>截止今天到期未收利息总额</small>
              </div>
          </div>
      </div>
      ...
      <div class="col-sm-3">
          <div class="ibox float-e-margins">
              ...
              <div class="ibox-content">
                  <h1 class="no-margins"><?php echo (money_format($all_late_money)); ?></h1>
      ...
      <div class="col-sm-3">
          <div class="ibox float-e-margins">
              ...
              <div class="ibox-content">
                  <h1 class="no-margins"><?php echo (money_format($all_borrow_procedures)); ?></h1>
                  <div class="stat-percent font-bold text-success"></div>
                  <small>应收手续费总额</small>
              </div>
          </div>
      ...
      <div class="col-sm-3">
          <div class="ibox float-e-margins">
              ...
              <div class="ibox-content">
                  <h1 class="no-margins"><?php echo (money_format($all_borrow_interest)); ?></h1>
                  <div class="stat-percent font-bold text-success"></div>
                  <small>所有应收利息总额</small>
              </div>
          </div>
      </div>
      ...
      <div class="col-sm-3">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <span class="label label-danger pull-right">元</span>
                  <h5 class="text-danger">实收利息</h5>
              </div>
              <div class="ibox-content">
                  <h1 class="no-margins"><?php echo (money_format($re_borrow_interest)); ?></h1>
      ...
      <div class="col-sm-3">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <span class="label label-danger pull-right">元</span>
                  <h5 class="text-danger">实收逾期费用</h5>
              </div>
              <div class="ibox-content">
                  <h1 class="no-margins"><?php echo (money_format($re_late_money)); ?></h1>
                  <div class="stat-percent font-bold text-danger"></div>
                  <small>实收逾期总额</small>
              </div>
          </div>
      ...
      <div class="col-sm-3">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <span class="label label-danger pull-right">元</span>
                  <h5 class="text-danger">实收手续费</h5>
              </div>
              <div class="ibox-content">
                  <h1 class="no-margins"><?php echo (money_format($repayment_borrow_procedures)); ?></h1>
                  <div class="stat-percent font-bold text-danger"></div>
                  <small>实收手续费总额</small>
              </div>
          </div>
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                            <div class="input-group m-b"><span class="input-group-btn">
                                    <button type="button" class="btn btn-primary" >借款序号</button> </span>
                                    <input type="text" class="form-control" id="borrow_number" placeholder="模糊">
                            </div>
                    </div>
                    <div class="col-sm-2">
                            <div class="input-group m-b"><span class="input-group-btn">
                                    <button type="button" class="btn btn-primary" >借款人</button> </span>
                                    <input type="text" class="form-control" id="borrow_uname" placeholder="模糊">
                            </div>
                    </div>
                    <div class="col-sm-6" id="export-btn">
                            <a data-type="xls" data-table="index_table" href="javascript:;" type="button" class="btn btn-danger btn-sm">导出xls</a>
                    </div>
                </div>
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover dataTables-example" id="index_table">
                        <thead>
                            <tr>
                                  <th></th>
                                  <th>编号</th>
