    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <div class="row">
                        <div class="col-sm-6">
                                <a href="<?php echo U('Config/dbbak',array('Action'=>'backup'));?>" type="button" class="btn btn-danger btn-sm">备份</a>
                        </div>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tbody>
                            <?php if(is_array($file_list)): foreach($file_list as $key=>$list): if($key > 1): ?><tr>
                                    ...
                                    <td style="text-align: left"><a href="<?php echo U('Config/dbbak',array('Action'=>'download','file'=>$list));?>"><?php echo ($list); ?></a></td>
                                    <td><?php echo (get_file_time($datadir,$list)); ?></td>
                                    <td><?php echo (get_file_size($datadir,$list)); ?></td>
                                    <td>
                                    <a href="<?php echo U('Config/dbbak',array('Action'=>'download','file'=>$list));?>">下载</a>
                                    <a onclick="return confirm('确定将数据库还原到当前备份吗？')"href="<?php echo U('Config/dbbak',array('Action'=>'RL','File'=>$list));?>">还原</a>
                                    <a onclick="return confirm('确定删除该备份文件吗？')"href="<?php echo U('Config/dbbak',array('Action'=>'Del','File'=>$list));?>">删除</a>
                                    </td>
