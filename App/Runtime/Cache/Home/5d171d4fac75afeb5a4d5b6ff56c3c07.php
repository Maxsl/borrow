    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <form method="post" class="form-horizontal" action="/borrow/index.php/Home/Borrow/add_act" id="add_borrow">
		...
		<div class="col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" class="form-control" name="borrow_interest_rate">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" class="form-control" name="borrow_procedures_rate">
                            <span class="help-block m-b-none">%</span>
                        </div>
                    </div>
