        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal" action="/borrow/index.php/Home/Repayment/edit_act">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">借款信息</label>
                            <div class="col-md-3">
                                <a href="/borrow/index.php/Home/borrow/edit/id/<?php echo ($borrow_repayment_list["borrow_id"]); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <a href="/borrow/index.php/Home/user/index/id/<?php echo ($borrow_repayment_list["borrow_uid"]); ?>"><button type="button" class="btn btn-w-m btn-primary"><?php echo ($borrow_repayment_list["name"]); ?></button></a>
                            </div>
                        </div>
                        <div class="form-group">
